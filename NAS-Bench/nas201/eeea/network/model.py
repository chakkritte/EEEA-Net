...
from eeea.network.operations import *
from torch.autograd import Variable
from eeea.utils.utils import drop_path
from eeea.utils.utils import drop_path_fp16
...
class PyramidNetworkCIFAR(nn.Module):
  def __init__(self, C, num_classes, layers, auxiliary, genotype, drop_path_prob, mode, SE=False, increment=4):

...
from .backbones.nasnet import _BuildNAS
from .backbones.NSGA import _BuildNSGA
...
class YOLOv4(nn.Module):
    def __init__(self, weight_path=None, out_channels=255, resume=False):
        ...
        elif cfg.MODEL_TYPE["TYPE"] == 'NasNet-YOLOv4':
            # _BuildNAS backbone
            self.backbone, feature_channels = _BuildNAS(weight_path=weight_path, resume=resume)
        elif cfg.MODEL_TYPE["TYPE"] == 'NSGA-YOLOv4':
            # _BuildNAS backbone
            self.backbone, feature_channels = _BuildNSGA(weight_path=weight_path, resume=resume)
        else:

...
def parse_args():
    ...
    parse.add_argument('--nccl_ip', default='2', type=str)
...
def train():
    ...
    dl = DataLoader(ds, batch_size=args.bs, shuffle=False, sampler=sampler, num_workers=8, pin_memory=True, drop_last=True)

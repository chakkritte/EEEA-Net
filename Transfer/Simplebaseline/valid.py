...
def parse_args():
    ...
    parser.add_argument('--cfg', default='experiments/coco_256x192_d256x3_adam_lr1e-3.yaml')
...
def reset_config(config, args):
    ...
    config.TEST.MODEL_FILE = 'output/{}/posenet_{}/{}/model_best.pth.tar'.format(dataset_name, args.net, cfg_name.split('.yaml')[0])

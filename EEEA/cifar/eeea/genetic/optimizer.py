...
class Optimizer():
    ...
    def params_threshold(self, networks, args):
        ...
        if args.pyramid == False:
            modelLarge = NetworkCIFAR(args.init_channels, args.classes, 20, args.auxiliary, network_mixed, args.dropout_rate, args.mode, args.SE)
        else:
            modelLarge = PyramidNetwork(args.init_channels, args.classes, 20, args.auxiliary, network_mixed, args.dropout_rate, args.mode, args.SE, args.increment)       
    ...
    def fitness(self, network):
        ...
        if self.args.objective == 'single':
            ...
            return ( 100-network.accuracy, network.params, network.flops, network.epoch_time)
